              ...
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div class="pad">
                    ...
                    <!-- Buttons -->
                    <p>
                      <button class="btn btn-default btn-sm"><i class="fa fa-cloud-download"></i>
                        Generate PDF
                      </button>
                    </p>
                  </div>
        ...
        <section class="col-lg-6 connectedSortable">
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer clearfix no-border">
              <button class="btn btn-default pull-right"><i class="fa fa-plus"></i> Add item
              </button>
            </div>
          </div>
          <!-- /.box -->
...
<!-- jQuery 2.0.2 -->
<%--<script src="js/jquery/jquery.min-2.0.2.js"></script>--%>
<!-- jQuery UI 1.10.3 -->
<%--<script src="js/jquery-ui-1.10.3.min.js" type="text/javascript"></script>--%>
<!-- Bootstrap -->
<%--<script src="js/bootstrap.min.js" type="text/javascript"></script>--%>
<!-- Morris.js charts -->
<script src="<%= path %>/js/raphael/raphael-min.js"></script>
<script src="<%= path %>/js/plugins/morris/morris.min.js" type="text/javascript"></script>
<!-- Sparkline -->
<script src="<%= path %>/js/plugins/sparkline/jquery.sparkline.min.js"
        type="text/javascript"></script>
<!-- jvectormap -->
<script src="<%= path %>/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"
        type="text/javascript"></script>
<script src="<%= path %>/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"
        type="text/javascript"></script>
<!-- fullCalendar -->
<script src="<%= path %>/js/plugins/fullcalendar/fullcalendar.min.js"
        type="text/javascript"></script>
<!-- jQuery Knob Chart -->
<script src="<%= path %>/js/plugins/jqueryKnob/jquery.knob.js" type="text/javascript"></script>
<!-- daterangepicker -->
<script src="<%= path %>/js/plugins/daterangepicker/daterangepicker.js"
        type="text/javascript"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<%= path %>/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"
        type="text/javascript"></script>
<!-- iCheck -->
<script src="<%= path %>/js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>

<!-- AdminLTE App -->
<%--<script src="<%= path %>/js/AdminLTE/app.js" type="text/javascript"></script>--%>

<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<%= path %>/js/AdminLTE/dashboard.js" type="text/javascript"></script>
