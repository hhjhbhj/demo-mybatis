...
<head>
  ...
  <!-- fullCalendar -->
  <link href="<%= path %>/css/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" />
  <link href="<%= path %>/css/fullcalendar/fullcalendar.print.css" rel="stylesheet" type="text/css" media='print' />
</head>
