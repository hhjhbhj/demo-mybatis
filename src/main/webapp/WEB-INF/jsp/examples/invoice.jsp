  ...
  <aside class="right-side">
    ...
    <div class="pad margin no-print">
      <div class="alert alert-info" style="margin-bottom: 0!important;">
        ...
        <b>Note:</b> This page has been enhanced for printing. Click the print button at the bottom
        of the invoice to test.
      </div>
    </div>
    ...
    <section class="content invoice">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <img src="<%= path %>/img/credit/visa.png" alt="Visa"/>
          <img src="<%= path %>/img/credit/mastercard.png" alt="Mastercard"/>
          <img src="<%= path %>/img/credit/american-express.png" alt="American Express"/>
          <img src="<%= path %>/img/credit/paypal2.png" alt="Paypal"/>
