  ...
  <aside class="right-side">
    ...
    <section class="content">
      ...
      <div class='callout callout-info'>
        ...
        <p>The following three inline (sparkline) chart have been initialized to read and interpret
          data tags</p>
      </div>
      <!-- /.callout -->
...
<!-- Sparkline -->
<script src="<%= path %>/js/plugins/sparkline/jquery.sparkline.min.js" type="text/javascript"></script>
