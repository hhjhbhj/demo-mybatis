          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="alert alert-danger alert-dismissable">
                ...
                <b>Alert!</b> Danger alert preview. This alert is dismissable. A wonderful serenity
                has taken possession of my entire soul, like these sweet mornings of spring which I
        ...
        <div class="col-md-6">
          <div class="box box-solid">
            ...
            <div class="box-body text-center">
              <p>By adding the class <code>.vertical</code> and <code>.xs</code> or <code>.sm</code>
                we achieve:</p>
