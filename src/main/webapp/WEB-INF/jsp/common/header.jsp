            ...
            <li>
              ...
              <ul class="menu">
                <li><!-- start message -->
                  <a href="#">
                    <div class="pull-left">
                      <img src="<%=request.getContextPath() %>/img/avatar3.png"
                ...
                <li>
                  <a href="#">
                    <div class="pull-left">
                      <img src="<%=request.getContextPath() %>/img/avatar2.png"
                           class="img-circle" alt="user image"/>
                    </div>
                    <h4>
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              ...
              <ul class="menu">
                <li>
                  <a href="#">
                    <i class="ion ion-ios7-people info"></i> 5 new members
                    joined today
                  </a>
                </li>
                <li>
                  <a href="#">
                    <i class="fa fa-warning danger"></i> Very long description
